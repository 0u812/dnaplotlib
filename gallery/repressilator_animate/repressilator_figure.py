...
plac_color = (0.38, 0.65, 0.87)
ptet_color = (1.00, 0.75, 0.17)
...
tetr = {'name':'tetR', 'start':21, 'end':40, 'type':'CDS', 'opts':{'label': 'tetR', 'fontsize': 8,  'label_y_offset': 0, 'label_x_offset': -2, 'label_style':'italic', 'color':ptet_color}}
